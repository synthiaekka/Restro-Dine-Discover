        ...
        <div class="login-container container">
            ...
            <div id="login-form">
                ...
                <form action="./htServer/login.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary" value="login_user" name="login">Login As User</button> <br>
                    <button type="submit" class="btn btn-primary" value="login_manager" name="login">Login As Manager</button>
                </form>
